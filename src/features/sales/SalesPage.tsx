          ...
          <div className="space-y-3 pt-3 border-t border-slate-100">
            ...
            <div className="grid grid-cols-2 gap-2">
              <input
                ...
                className="h-11 rounded-xl bg-slate-100 px-3 text-sm font-bold outline-none focus:ring-2 focus:ring-primary/20 transition-all"
              />
              <input
                type="text"
                placeholder="Cliente"
            ...
            >
              {state.loading ? "PROCESANDO..." : "CONFIRMAR VENTA"}
            </Button>
          </div>
        </section>
      </div>
