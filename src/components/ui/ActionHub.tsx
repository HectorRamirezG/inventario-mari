      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ...
            className="absolute left-0 right-0 bottom-0 bg-white/95 dark:bg-slate-900/95 backdrop-blur-3xl border-t border-white/40 dark:border-slate-700/40 rounded-t-[2rem] pb-safe shadow-[0_-25px_60px_-15px_rgba(0,0,0,0.3)]"
          >
            ...
            <div className="grid grid-cols-2 gap-3 px-5 pt-3 pb-7">
              {actions.map((a, i) => (
                <motion.button
                  key={a.id}
